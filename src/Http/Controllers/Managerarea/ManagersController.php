...
class ManagersController extends AuthorizedController
{
    ...
    protected function process(FormRequest $request, Manager $manager)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/auth::tenantable.manager'), 'identifier' => $manager->getRouteKey()])],
        ]);
    }
    ...
    public function destroy(Manager $manager)
    {
        ...
        return intend([
            'url' => route('managerarea.cortex.auth.managers.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/auth::tenantable.manager'), 'identifier' => $manager->getRouteKey()])],
        ]);
    }
}
