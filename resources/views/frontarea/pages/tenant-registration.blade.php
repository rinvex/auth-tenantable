                        ...
                        <div id="accordion" class="wizard">
                            <div class="panel wizard-step">
                                <div>
                                    <h4 class="wizard-step-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">{{ trans('cortex/auth::tenantable.manager_account') }}</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel wizard-step">
                                <div role="tab" id="headingTwo">
                                    <h4 class="wizard-step-title">
                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">{{ trans('cortex/auth::tenantable.tenant_details') }}</a>
                                    </h4>
                                </div>
