    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                @includeWhen($manager->exists, 'cortex/foundation::adminarea.partials.actions', ['name' => 'manager', 'model' => $manager, 'resource' => trans('cortex/auth::tenantable.manager'), 'routePrefix' => 'adminarea.cortex.auth.managers'])
